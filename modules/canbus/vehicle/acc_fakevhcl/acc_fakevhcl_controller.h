...
class Acc_fakevhclController final : public VehicleController {
 public:

  explicit Acc_fakevhclController() {};

  virtual ~Acc_fakevhclController();
 ...
 private:
  // control protocol
  Vcbrake63* vc_brake_63_ = nullptr;
  Vcgas62* vc_gas_62_ = nullptr;
