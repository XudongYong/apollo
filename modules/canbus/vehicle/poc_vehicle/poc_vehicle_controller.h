...
class Poc_vehicleController final : public VehicleController {
 public:

  explicit Poc_vehicleController() {};

  virtual ~Poc_vehicleController();
 ...
 private:
  ...
  //void set_driving_mode(const Chassis::DrivingMode &driving_mode) override;
 ...
 private:
  // control protocol
  Accinfo41* acc_info_41_ = nullptr;
