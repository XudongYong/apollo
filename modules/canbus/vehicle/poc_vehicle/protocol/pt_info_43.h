...
class Ptinfo43 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  int lateral_acceleration(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int vehicle_speed(const std::uint8_t* bytes, const int32_t length) const;
};
