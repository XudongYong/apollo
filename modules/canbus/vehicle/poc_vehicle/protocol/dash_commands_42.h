...
class Dashcommands42 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  bool acc_enabled(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int minimum_follow_distance(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int target_vehicle_speed(const std::uint8_t* bytes, const int32_t length) const;
};
